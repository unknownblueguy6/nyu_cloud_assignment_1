...
$(document).ready(function() {
  ...
  function checkAndSetCookie() {
    if (!Cookies.get(cookieName)) {
      // Set the cookie with initial data
      const initialState = (Math.random() + 1).toString(36).substring(7);;
      Cookies.set(cookieName, initialState, { expires: 365, sameSite: 'strict'});
